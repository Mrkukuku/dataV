                ...
                tooltip: {
                    ...
                    formatter: function(params, ticket, callback) {
                        ...
                        for ( var i=0;i<params.length;i++) {
                            result += params[i].marker +"时间："+params[0].name + "<br/>"
                            result += params[i].marker + "三相电流: "+ params[0].value[1]+ "<br/>";
                            result += params[i].marker + "温度: "+ params[0].value[2]+ "<br/>"
                            result += params[i].marker + "剩余电流: "+ params[0].value[3]
                        }
